...
class RLHflow8bPRM(PRM):
    def __init__(
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('RLHFlow/Llama3.1-8B-PRM-Mistral-Data')
        self.model = AutoModelForCausalLM.from_pretrained('RLHFlow/Llama3.1-8B-PRM-Mistral-Data', torch_dtype=torch.bfloat16).eval().to(self.device)
